...
when exe <----------- exe ------------------->
python -m PyInstaller --onefile --windowed --icon=mosque.ico --add-data "background.jpg;." --add-data "adhan.wav;." --add-data "close.png;." --add-data "minimize.png;." --add-data "meknes_prayer_times_2025.csv;." --add-data "mosque.ico;." mosque_app.py